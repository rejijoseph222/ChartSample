...
public class MainActivity extends Activity
{
	...
	private Double[] grossSal= {15000.1,15000.30,15000.25,15000.1,15000.0,15000.0,15000.0,15000.0,15000.25,15000.1,15000.0,15000.0};
	...
	private void updateSizeInfo() {
    	...
    	listview1.setAdapter(new bsAdapter(this,datelabel));
    	listview2.setAdapter(new bsAdapter(this,datelabel));
